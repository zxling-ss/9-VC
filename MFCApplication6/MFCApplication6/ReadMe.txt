...
res\Toolbar.bmp
    此位图文件用于为工具栏创建平铺图像。
    初始工具栏和状态栏在 CMainFrame 类中构造。使用资源编辑器编辑此工具栏位图，并更新 MFCApplication6.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导创建一种文档类型和一个视图：

MFCApplication6Doc.h、MFCApplication6Doc.cpp - 文档
    这些文件包含 CMFCApplication6Doc 类。编辑这些文件以添加特殊文档数据并实现文件保存和加载（通过 CMFCApplication6Doc::Serialize）。

MFCApplication6View.h、MFCApplication6View.cpp - 文档视图
    这些文件包含 CMFCApplication6View 类。
    CMFCApplication6View 对象用于查看 CMFCApplication6Doc 对象。
